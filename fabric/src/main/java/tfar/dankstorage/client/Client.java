...
public class Client {
    ...
    public static void client() {
        ...
        ScreenRegistry.register(DankStorageFabric.dank_1_container, DankStorageScreen::t1);
        ScreenRegistry.register(DankStorageFabric.portable_dank_1_container, DankStorageScreen::t1);
        ScreenRegistry.register(DankStorageFabric.dank_2_container, DankStorageScreen::t2);
        ScreenRegistry.register(DankStorageFabric.portable_dank_2_container, DankStorageScreen::t2);
        ScreenRegistry.register(DankStorageFabric.dank_3_container, DankStorageScreen::t3);
        ScreenRegistry.register(DankStorageFabric.portable_dank_3_container, DankStorageScreen::t3);
        ScreenRegistry.register(DankStorageFabric.dank_4_container, DankStorageScreen::t4);
        ScreenRegistry.register(DankStorageFabric.portable_dank_4_container, DankStorageScreen::t4);
        ScreenRegistry.register(DankStorageFabric.dank_5_container, DankStorageScreen::t5);
        ScreenRegistry.register(DankStorageFabric.portable_dank_5_container, DankStorageScreen::t5);
        ScreenRegistry.register(DankStorageFabric.dank_6_container, DankStorageScreen::t6);
        ScreenRegistry.register(DankStorageFabric.portable_dank_6_container, DankStorageScreen::t6);
        ScreenRegistry.register(DankStorageFabric.dank_7_container, DankStorageScreen::t7);
        ScreenRegistry.register(DankStorageFabric.portable_dank_7_container, DankStorageScreen::t7);
