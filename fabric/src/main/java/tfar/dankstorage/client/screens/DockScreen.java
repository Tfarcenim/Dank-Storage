...
public class DockScreen extends AbstractDankStorageScreen<DockMenu> {
    ...
    static final ResourceLocation background1 = new ResourceLocation(DankStorageFabric.MODID,
            "textures/container/gui/dank1.png");
    static final ResourceLocation background2 = new ResourceLocation(DankStorageFabric.MODID,
            "textures/container/gui/dank2.png");
    static final ResourceLocation background3 = new ResourceLocation(DankStorageFabric.MODID,
            "textures/container/gui/dank3.png");
    static final ResourceLocation background4 = new ResourceLocation(DankStorageFabric.MODID,
            "textures/container/gui/dank4.png");
    static final ResourceLocation background5 = new ResourceLocation(DankStorageFabric.MODID,
    ...
    static final ResourceLocation background7 = new ResourceLocation(DankStorageFabric.MODID,
