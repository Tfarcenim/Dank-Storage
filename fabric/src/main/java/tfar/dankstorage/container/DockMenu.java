...
public class DockMenu extends AbstractDankMenu {
    ...
    public DockMenu(MenuType<?> type, int windowId, Inventory playerInventory, int rows) {
        this(type, windowId, playerInventory, new DankInventoryFabric(Utils.getStatsfromRows(rows), -1),null);
    }

    public DockMenu(MenuType<?> type, int id, Inventory playerInventory, DankInventoryFabric dankInventoryFabric, DockBlockEntity dock) {
        super(type, id, playerInventory, dankInventoryFabric);
        addDankSlots();
    ...
    //server
    public static DockMenu t1s(int windowId, Inventory playerInventory, DankInventoryFabric inventory, DockBlockEntity dock) {
        return new DockMenu(DankStorageFabric.dank_1_container, windowId, playerInventory, inventory,dock);
    }

    public static DockMenu t2s(int windowId, Inventory playerInventory, DankInventoryFabric inventory, DockBlockEntity dock) {
        return new DockMenu(DankStorageFabric.dank_2_container, windowId, playerInventory, inventory,dock);
    }

    public static DockMenu t3s(int windowId, Inventory playerInventory, DankInventoryFabric inventory, DockBlockEntity dock) {
        return new DockMenu(DankStorageFabric.dank_3_container, windowId, playerInventory, inventory,dock);
    }

    public static DockMenu t4s(int windowId, Inventory playerInventory, DankInventoryFabric inventory, DockBlockEntity dock) {
        return new DockMenu(DankStorageFabric.dank_4_container, windowId, playerInventory, inventory,dock);
    }

    public static DockMenu t5s(int windowId, Inventory playerInventory, DankInventoryFabric inventory, DockBlockEntity dock) {
        return new DockMenu(DankStorageFabric.dank_5_container, windowId, playerInventory, inventory,dock);
    }

    public static DockMenu t6s(int windowId, Inventory playerInventory, DankInventoryFabric inventory, DockBlockEntity dock) {
        return new DockMenu(DankStorageFabric.dank_6_container, windowId, playerInventory, inventory,dock);
    }

    public static DockMenu t7s(int i, Inventory playerInventory, DankInventoryFabric inventory, DockBlockEntity dock) {
