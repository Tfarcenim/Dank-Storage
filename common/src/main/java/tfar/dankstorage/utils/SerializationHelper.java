...
public class SerializationHelper {
    ...
    public static final Codec<ItemStack> LARGE_CODEC = Codec.lazyInitialized(
    ...
    public static void encodeLargeStack(ItemStack stack, HolderLookup.Provider provider, CompoundTag tag) {
        LARGE_CODEC.encode(stack, provider.createSerializationContext(NbtOps.INSTANCE), tag).getOrThrow();
    }
